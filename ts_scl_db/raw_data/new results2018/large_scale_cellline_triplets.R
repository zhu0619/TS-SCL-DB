...
args = c('DB_result/new/Zscore_all_tissueCL_scl_pubmed_ID.txt_CellLine_T_2018-01-02_a_0.6_ws_3_wa_0.2_human.csv',
         'HPA_CellLine_SCL_ground_truth.csv', 'empty', 'hpa_go_scl_map_with_celljunction.txt', 'TRUE')

args = c('DB_result/Zscore_all_tissueCL_scl_pubmed_ID.txt_CellLine_T_2017-12-16_a_0.6_ws_0.2_wa_3_human.csv',
         'HPA_CellLine_SCL_ground_truth.csv', 'empty', 'hpa_go_scl_map_with_celljunction.txt', 'TRUE')
...
library('pROC')
  ...
  plot(dens,xlim=c(-1,2),main = "",xlab='Zscore')
  po = which.max(dens$y)
  grid()
  ...
  legend('topright', pch=15,col=c("darkgrey","steelblue"),c("Background","True triplets"),bt='n')
